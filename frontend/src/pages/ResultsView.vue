...
async function performSearch(query) {
  ...
  results.value = getFilteredResults(webData.results)
  resultsCount.value = webData.count
  searchTime.value = webData.time
  imageResults.value = imgData
  newsResults.value = getFilteredResults(newsData)
...
.result-url-info {
  ...
  .inline-related-grid::-webkit-scrollbar {
    display: none;
  }
