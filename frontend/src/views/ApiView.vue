        ...
        <div class="documentation-section">
          ...
          <div class="doc-card">
            ...
            <div class="code-block">
              <code>http://localhost:3000/api/search?q=YOUR_QUERY&apikey=YOUR_API_KEY</code>
            </div>
            ...
            <div class="code-block">
              <pre>curl -X GET "http://localhost:3000/api/search?q=github&apikey={{ apiKey }}"</pre>
            </div>

            <h3 class="doc-subtitle">Örnek İstek (JavaScript)</h3>
            <div class="code-block">
              <pre>fetch('http://localhost:3000/api/search?q=github&apikey={{ apiKey }}')
...
const testApiSearch = async () => {
  ...
  try {
    const response = await fetch(`http://localhost:3000/api/search?q=${encodeURIComponent(testQuery.value)}&apikey=${apiKey.value}`);
...
const regenerateKey = async () => {
  ...
  try {
    const response = await fetch('http://localhost:3000/auth/regenerate', {
      method: 'POST',
      headers: {
